...
//        Come back to the Clarusway using the back command.
        driver.navigate().back();//back() methodu önceki sayfaya geri döner
        Thread.sleep(4000);//4 saniye sonra kapatır

//        Again go back to the Google website using forward command
        driver.navigate().forward();//Bu yöntem,web tarayıcısının mevcut tarayıcı pencesindeki ileri düğmesine tıklamasını sağlar.
        Thread.sleep(3000);
